...
void CrustCrawler::grip(bool grip) {
    if (grip) {
      //  CrustCrawler::move_joint(_SHA_ID_GRIP, _ID_GRIP_EXPOS[2]);
        _pSerial->torqueOn(4);
        _pSerial->torqueOn(5);
        _pSerial->setGoalPosition(4, 2000, UNIT_RAW);
        _pSerial->setGoalPosition(5, 2000, UNIT_RAW);
        while(!(_pSerial->getPresentPosition(4) > 1990 && _pSerial->getPresentPosition(4) < 2010 && _pSerial->getPresentPosition(5) > 1990 && _pSerial->getPresentPosition(5) < 2010)) {
      ...
      //  CrustCrawler::move_joint(_SHA_ID_GRIP, _ID_GRIP_EXPOS[1]);
        _pSerial->torqueOn(4);
        _pSerial->torqueOn(5);
        _pSerial->setGoalPosition(4, 1100, UNIT_RAW);
        _pSerial->setGoalPosition(5, 1100, UNIT_RAW);
        while(!(_pSerial->getPresentPosition(4) > 1090 && _pSerial->getPresentPosition(4) < 1110 && _pSerial->getPresentPosition(5) > 1090 && _pSerial->getPresentPosition(5) < 1110)) {
